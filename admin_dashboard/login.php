...
?>
<body style="background-image: url(assets/img/bg3.webp);background-repeat: no-repeat;
	...
	<form class="form loginform" method="POST" action="authenticate.php">
		<div class="login-panel panel panel-default">
			...
			<div class="panel-body">
				...
				<button class="btn btn-danger loginField"><a href="../accueil.php" style="text-decoration: none; color: white;">Retour</a></button>
			</div>
		</div>
	</form>
</div>
