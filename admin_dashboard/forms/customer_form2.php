<fieldset>
    ...
    <div class="form-group">
        ...
        <input type="text" name="l_name" value="<?php echo htmlspecialchars($edit ? $customer['username'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="Username" class="form-control" required="required" id="username" disabled>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="password" name="password" value="<?php echo htmlspecialchars($edit ? $customer['password'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="Password" class="form-control" required="required" id="password" disabled>
    </div>

    <div class="form-group">
        <label>State </label>
           <?php $opt_arr = array("Algeria", "Benin", "Burkina", "Congo", "Cameroun", "Danmark", "France", "Great Bretain", "Germany", "Ivory Cost", "Mali", "Morroco", "Mauritanie", "Nigeria", "Senegal", "South Africa", "Togo", "Tanzanie", "other"); 
                            ?>
